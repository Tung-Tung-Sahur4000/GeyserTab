package fun.nizhal.crossplay.adapters;
 ...
 * Registers CrossplayProvider instances for /warp and /home so CrossplayNav
 * picks them up automatically — Essentials owns all data and logic,
 * we only add the Bedrock UI layer.
 *
 * All EssentialsX API references are isolated in this class.
 */
public final class EssentialsAdapter {
    ...
    public static void register(Plugin registrar) {
        ...
        // /warp — global list from Essentials
        ...
        // /home — per-player list from Essentials
        sm.register(CrossplayProvider.class, new CrossplayProvider() {
